...
export async function updateJoblisting(
  ...
  try {
    ...
    const { id } = req.params;
    const joblisting = req.body;
    const data = await JoblistingService.updateJoblisting(
      userId!,
      parseInt(id),
      joblisting
    );
...
export function deleteJoblistingById(
  req: Request,
  res: Response,
  next: NextFunction
) {
...
export async function getJoblistingByFilter(
  req: Request,
  res: Response,
  next: NextFunction
) {
...
export async function getJoblistingByUserId(
  req: Request,
  res: Response,
  next: NextFunction
) {
...
export async function totaljobpostByUser(
  req: Request,
  res: Response,
  next: NextFunction
) {
...
export async function totalactiveJobByEmployer(
  req: Request,
  res: Response,
  next: NextFunction
) {
